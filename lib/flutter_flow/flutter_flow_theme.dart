...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFFEBEBEB);
  late Color secondaryColor = const Color(0xFFEFFF9B);
  late Color tertiaryColor = const Color(0xFFFF9626);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryBackground = const Color(0xFFFCDD73);
